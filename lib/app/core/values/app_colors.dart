...
abstract class AppColors {
  static Color primary = Color.fromARGB(255, 0, 75, 136);
  ...
  static const Color gameAppBarColor = Color.fromARGB(255, 0, 75, 136);
  static const Color appBarIconColor = Color(0xFFFFFFFF);
  static const Color appBarTextColor = Color(0xFFFFFFFF);
  static const Color primaryLoginTextColor = Color(0xFF293040);
  static Color activePlayButtonColor = const Color.fromARGB(255, 117, 255, 122);
  static Color inActivePlayButtonColor = Colors.red;
  static Color errorRed = Colors.red;
  static Color successGreen = Colors.green;
  ...
  static const Color loginbackgroundColor = Color(0x090c22);

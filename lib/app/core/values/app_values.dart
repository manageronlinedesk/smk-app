...
abstract class AppValues {
  // static const String adminId = '1704902423358';
  static const String adminId = '1708317407';
  ...
  static int jodiDigitMaxLength = 2;
  static int singleDigitMaxLength = 1;
  static int singlePannaMaxLength = 3;
  static int doublePannaMaxLength = 3;
  static int triplePannaMaxLength = 3;

  static double formTitleSize = 25.0;
  static FontWeight formTitleWeight = FontWeight.w500;
  static double gameCardSize = Get.width / 2.55;
  static double gameCardVerticalSpacing = 10;

  static int tileShakeTime = 500;

  static int maxAmountLength = 5;
